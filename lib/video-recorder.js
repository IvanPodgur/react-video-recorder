...
var Wrapper = _styledComponents["default"].div.withConfig({
  ...
  "position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:55%;overflow:hidden;min-height:300px;background-color:#a779e9;color:white;box-sizing:border-box;*{box-sizing:inherit;}"
]);

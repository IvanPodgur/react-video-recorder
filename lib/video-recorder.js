...
var Wrapper = _styledComponents["default"].div.withConfig({
  ...
  "position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;object-fit:contain;width:100%;height:100%;overflow:hidden;min-height:300px;background-color:#a779e9;color:white;box-sizing:border-box;*{box-sizing:inherit;}"
]);
...
var CameraView = _styledComponents["default"].div.withConfig({
  displayName: "video-recorder__CameraView",
  componentId: "sc-7k20rv-1"
})(["width:20%;height:20%;object-fit:contain;"]);
...
var Video = _styledComponents["default"].video.withConfig({
  ...
  [
    "position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);object-fit:contain;",
    ";"
  ],
  function(props) {
    return props.onClick && "cursor: pointer;";

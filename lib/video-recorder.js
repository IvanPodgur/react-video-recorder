...
// })([
//   "position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;overflow:hidden;min-height:300px;background-color:#a779e9;color:white;box-sizing:border-box;*{box-sizing:inherit;}"
// ]);
...
var Wrapper = _styledComponents["default"].div.withConfig({
  ...
  "position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:55%;overflow:hidden;min-height:300px;background-color:white;color:#a779e9;box-sizing:border-box;*{box-sizing:inherit;}"
]);
...
//   componentId: "sc-7k20rv-0"
// })([
//   "position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;object-fit:contain;width:40%;height:40%;overflow:visible;min-height:300px;background-color:#a779e9;color:white;box-sizing:border-box;*{box-sizing:inherit;}"
// ]);
...
var VideoRecorder =
  ...
  (function(_Component) {
    ...
    function VideoRecorder(props) {
      ...
      _this.handleConfirm = _this.handleConfirm.bind(
        _assertThisInitialized(_this)
      );
        ...
        value: function startRecording() {
          ...
          (0, _getVideoInfo.captureThumb)(this.cameraVideo).then(function(
            ...
            try {
              ...
              _this6.mediaRecorder = new window.MediaRecorder(
                _this6.stream,
                options
              );
        ...
        value: function handleVideoSelected(e) {
          ...
          (0, _getVideoInfo["default"])(video)
            .then(function(_ref) {
              ...
              _this7.props.onRecordingComplete(
                video,
                startedAt,
                thumbnail,
                duration,
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            attemptsLeft = _this$props2.attemptsLeft,
...
_defineProperty(VideoRecorder, "propTypes", {
  ...
  onAttemptComplete: _propTypes["default"].func,
  attemptsLeft: _propTypes["default"].number,

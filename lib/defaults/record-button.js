...
var Button = _styledComponents["default"].button.withConfig({
  ...
  [
    "background:",
    ";color:",
    ";border-radius:50%;width:26px;height:26px;background:rgba(227,73,28,0.8);outline:none;border:none;cursor:pointer;:hover{background:#fb6d42;}"
  ],
  function(props) {
...
var ButtonBorder = _styledComponents["default"].div.withConfig({
  ...
  "border:4px solid rgba(255,255,255,0.4);height:43px;width:43px;border-radius:50%;"
]);

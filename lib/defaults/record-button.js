...
var Button = _styledComponents["default"].button.withConfig({
  ...
  [
    "background:",
    ";color:",
    ";border-radius:50%;width:30px;height:30px;background:rgba(227,73,28,0.8);outline:none;border:none;cursor:pointer;:hover{background:#fb6d42;}"
  ],
  function(props) {
...
var ButtonBorder = _styledComponents["default"].div.withConfig({
  ...
  "border:6px solid rgba(255,255,255,0.4);height:50px;width:50px;border-radius:50%;"
]);
...
var _default = function _default(props) {
  return _react["default"].createElement(
    ...
    _react["default"].createElement(
      Instructions,
      null,
      _react["default"].createElement("div", null, "PRESS "),
